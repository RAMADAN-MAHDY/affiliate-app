...
//   console.log(URL);
  ...
  return (
    <div className="relative w-full md:h-[55vh] sm:mt-[0px] overflow-hidden">
    <div className="relative w-full h-[35vh] md:h-[55vh] lg:h-[70vh] flex items-center justify-center">
